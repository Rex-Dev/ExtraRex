...
if is_banned(data.id, arg.chat_id) then
   if not lang then
		tdbot.sendMessage(arg.chat_id, arg.msg_id, 0, "⇋ User "..user_name.." is ➲ *banned*", 0, "md")
   else
		tdbot.sendMessage(arg.chat_id, arg.msg_id, 0, "↜ کاربر "..user_name.."  از گروه *محروم* است", 0, "md")
end
kick_user(data.id, arg.chat_id)
end
if is_gbanned(data.id) then
     if not lang then
		tdbot.sendMessage(arg.chat_id, arg.msg_id, 0, "⇋ User "..user_name.." is globally ➲ *banned*", 0, "md")
    else
		tdbot.sendMessage(arg.chat_id, arg.msg_id, 0, "↜ کاربر "..user_name.." از تمام گروه های ربات *محروم* است", 0, "md")
   end
kick_user(data.id, arg.chat_id)
     end
	end
...
user_name = check_markdown(data.first_name)
  ...
  if not lang then
  return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ I can't ban ➲ *my self*", 0, "md")
   else
  ...
  if not lang then
  return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ You can't ban ➲ *mods,owners and bot admins*", 0, "md")
   else
...
if administration[tostring(arg.chat_id)]['banned'][tostring(data.id)] then
    if not lang then
     return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ User "..user_name.." is already ➲ *banned*", 0, "md")
   else
     return tdbot.sendMessage(arg.chat_id, "", 0, "↜ کاربر "..user_name.." * از گروه محروم بود*", 0, "md")
      end
   end
administration[tostring(arg.chat_id)]['banned'][tostring(data.id)] = user_name
   ...
   kick_user(data.id, arg.chat_id)
    if not lang then
    return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ User "..user_name.." has been ➲ *banned*", 0, "md")
    else
    return tdbot.sendMessage(arg.chat_id, "", 0, "↜ کاربر "..user_name.." *از گروه محروم شد*", 0, "md")
   end
end
assert(tdbot_function ({
    _ = "getUser",
...
if not administration[tostring(arg.chat_id)]['banned'][tostring(data.id)] then
    if not lang then
    return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ User "..user_name.." is not ➲ *banned*", 0, "md")
   else
    return tdbot.sendMessage(arg.chat_id, "", 0, "↜ کاربر "..user_name.." *از گروه محروم نبود*", 0, "md")
      end
   end
...
channel_unblock(arg.chat_id, data.id)
   if not lang then
    return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ User "..user_name.." has been ➲ *unbanned*", 0, "md")
   else
    return tdbot.sendMessage(arg.chat_id, "", 0, "↜ کاربر "..user_name.." *از محرومیت گروه خارج شد*", 0, "md")
   end
end
assert(tdbot_function ({
    _ = "getUser",
...
user_name = check_markdown(data.first_name)
     ...
     if data.id == our_id then
  if not lang then
  return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ I can't silent ➲ *my self*", 0, "md")
   else
  return tdbot.sendMessage(arg.chat_id, "", 0, "*↜ من نمیتوانم توانایی چت کردن رو از خودم بگیرم*", 0, "md")
   ...
   if is_mod1(arg.chat_id, data.id) then
  if not lang then
  return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ You can't silent ➲ *mods,owners and bot admins*", 0, "md")
    else
...
if administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id)] then
    if not lang then
     return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ User "..user_name.." is already ➲ *silent*", 0, "md")
  else
     return tdbot.sendMessage(arg.chat_id, "", 0, "↜ کاربر "..user_name.." *از قبل توانایی چت کردن رو نداشت*", 0, "md")
     end
   end
administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id)] = user_name
    save_data(_config.moderation.data, administration)
  if not lang then
     return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ User "..user_name.." added to ➲ *silent users list*", 0, "md")
  else
     return tdbot.sendMessage(arg.chat_id, "", 0, "↜ کاربر "..user_name.." *توانایی چت کردن رو از دست داد*", 0, "md")
   end
end
assert(tdbot_function ({
    _ = "getUser",
...
if not administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id)] then
   if not lang then
    return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ User "..user_name.." is not ➲ *silent*", 0, "md")
   else
    return tdbot.sendMessage(arg.chat_id, "", 0, "↜ کاربر "..user_name.." *از قبل توانایی چت کردن را داشت*", 0, "md")
      end
   end
administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id)] = nil
    save_data(_config.moderation.data, administration)
    if not lang then
     return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ User "..user_name.." removed from ➲ *silent users list*", 0, "md")
  else
     return tdbot.sendMessage(arg.chat_id, "", 0, "↜ کاربر "..user_name.." *توانایی چت کردن رو به دست آورد*", 0, "md")
   end
end
assert(tdbot_function ({
    _ = "getUser",
...
user_name = check_markdown(data.first_name)
  ...
  if not administration['gban_users'] then
    ...
    save_data(_config.moderation.data, administration)
     ...
     if data.id == our_id then
  if not lang then
  return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ I can't globally ban ➲ *my self*", 0, "md")
   else
  ...
  if not lang then
  return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ You can't ➲ *globally ban* other admins", 0, "md")
  else
...
if is_gbanned(data.id) then
   if not lang then
     return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ User "..user_name.." is already ➲ *globally banned*", 0, "md")
    else
     return tdbot.sendMessage(arg.chat_id, "", 0, "↜ کاربر "..user_name.." *از گروه های ربات محروم بود*", 0, "md")
      end
   end
  administration['gban_users'][tostring(data.id)] = user_name
   ...
   kick_user(data.id, arg.chat_id)
     if not lang then
     return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ User "..user_name.." has been ➲ *globally banned*", 0, "md")
   else
     return tdbot.sendMessage(arg.chat_id, "", 0, "↜ کاربر "..user_name.." *از تمام گروه های ربات محروم شد*", 0, "md")
   end
end
assert(tdbot_function ({
    _ = "getUser",
...
if not is_gbanned(data.id) then
   if not lang then
     return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ User "..user_name.." is not ➲ *globally banned*", 0, "md")
   else
     return tdbot.sendMessage(arg.chat_id, "", 0, "↜ کاربر "..user_name.." *از گروه های ربات محروم نبود*", 0, "md")
      end
   end
  administration['gban_users'][tostring(data.id)] = nil
    save_data(_config.moderation.data, administration)
    if not lang then
     return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ User "..user_name.." has been ➲ *globally unbanned*", 0, "md")
   else
     return tdbot.sendMessage(arg.chat_id, "", 0, "↜ کاربر "..user_name.." *از محرومیت گروه های ربات خارج شد*", 0, "md")
   end
end
assert(tdbot_function ({
    _ = "getUser",
  ...
  if not lang then
  return tdbot.sendMessage(data.chat_id, "", 0, "⇋ I can't kick ➲ *my self*", 0, "md")
   else
  return tdbot.sendMessage(data.chat_id, "", 0, "*↜ من نمیتوانم خودم رو از گروه اخراج کنم کنم*", 0, "md")
   ...
   if not lang then
  return tdbot.sendMessage(data.chat_id, "", 0, "⇋ You can't kick ➲ *mods,owners and bot admins*", 0, "md")
    elseif lang then
...
channel_unblock(data.chat_id, data.sender_user_id)
  ...
  if cmd == "delall" then
   ...
   if not lang then
  return tdbot.sendMessage(data.chat_id, "", 0, "⇋ You can't delete messages ➲ *mods,owners and bot admins*", 0, "md")
   elseif lang then
...
tdbot.deleteMessagesFromUser(data.chat_id, data.sender_user_id, dl_cb, nil)
   if not lang then
  return tdbot.sendMessage(data.chat_id_, "", 0, "⇋ All *messages* of *[ "..data.sender_user_id.." ]* has been ➲ *deleted*", 0, "md")
      elseif lang then
  ...
  return tdbot.sendMessage(data.chat_id, "", 0, "↜ ERROR 404❌\n*User Not Found*", 0, "md")
      end
   end
end
...
administration[tostring(arg.chat_id)]['banned'][tostring(data.id)] = user_name
   ...
   kick_user(data.id, arg.chat_id)
    if not lang then
    return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ User "..user_name.." *"..data.id.."* has been ➲ *banned*", 0, "md")
    else
    return tdbot.sendMessage(arg.chat_id, "", 0, "↜ کاربر "..user_name.." *"..data.id.."* *از گروه محروم شد*", 0, "md")
   end
end
assert(tdbot_function ({
    _ = "getUser",
...
administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id)] = user_name
    save_data(_config.moderation.data, administration)
  if not lang then
     return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ User "..user_name.." *"..data.id.."* added to ➲ *silent users list*", 0, "md")
  else
     return tdbot.sendMessage(arg.chat_id, "", 0, "↜ کاربر "..user_name.." *"..data.id.."* *توانایی چت کردن رو از دست داد*", 0, "md")
   end
end
assert(tdbot_function ({
    _ = "getUser",
...
assert(tdbot_function ({
  ...
  if cmd == "kick" then
     if data.id == our_id then
  if not lang then
  return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ I can't kick *my self*", 0, "md")
   else
  return tdbot.sendMessage(arg.chat_id, "", 0, "*↜ من نمیتوانم خودم رو از گروه اخراج کنم کنم*", 0, "md")
   ...
   if not lang then
  return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ You can't kick ➲ *mods,owners and bot admins*", 0, "md")
    elseif lang then
...
channel_unblock(arg.chat_id, data.id)
  ...
  if cmd == "delall" then
   if is_mod1(arg.chat_id, data.id) then
   if not lang then
  return tdbot.sendMessage(arg.chat_id, "", 0, "⇋ You can't delete messages ➲ *mods,owners and bot admins*", 0, "md")
   elseif lang then
...
tdbot.deleteMessagesFromUser(arg.chat_id, data.id, dl_cb, nil)
   if not lang then
  return tdbot.sendMessage(arg.chat_id_, "", 0, "⇋ All *messages* of "..data.title.." *[ "..data.id.." ]* has been ➲ *deleted*", 0, "md")
      elseif lang then
  ...
  return tdbot.sendMessage(arg.chat_id, "", 0, "*↜ ERROR 404❌\n*User Not Found**", 0, "md")
      end
   end
end
...
if not matches[2] and msg.reply_id then
  ...
  if not lang then
  return tdbot.sendMessage(msg.to.id, msg.id, 0, "⇋ I can't kick ➲ *my self*", 0, "md")
   else
  return tdbot.sendMessage(msg.to.id, msg.id, 0, "↜ *من نمیتوانم خودم رو از گروه اخراج کنم*", 0, "md")
   ...
   if not lang then
     tdbot.sendMessage(msg.to.id, "", 0, "⇋ You can't kick ➲ mods,owners or bot admins", 0, "md")
   elseif lang then
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   if not lang then
   return tdbot.sendMessage(msg.to.id, "", 0, "⇋ You can't delete messages ➲ mods,owners or bot admins", 0, "md")
     elseif lang then
...
tdbot.deleteMessagesFromUser(msg.to.id, matches[2], dl_cb, nil)
    if not lang then
  return tdbot.sendMessage(msg.to.id, "", 0, "⇋ All *messages* _of_ *[ "..matches[2].." ]* has been ➲ *deleted*", 0, "md")
   elseif lang then
 ...
 if (matches[1] == "superban" and is_admin(msg) and not Clang) or (matches[1] == "سوپر بن" and is_admin(msg) and Clang) then
if not matches[2] and msg.reply_id then
    assert(tdbot_function ({
      _ = "getMessage",
      chat_id = msg.to.id,
      message_id = msg.reply_id
    }, action_by_reply, {chat_id=msg.to.id,cmd="superban"}))
end
  if matches[2] and string.match(matches[2], '^%d+$') then
    if userid == our_id then
  if not lang then
  return tdbot.sendMessage(msg.to.id, msg.id, 0, "⇋ I can't ➲ globally ban *my self*", 0, "md")
   else
  return tdbot.sendMessage(msg.to.id, msg.id, 0, "*↜ من نمیتوانم خودم رو از تمام گروه های ربات محروم کنم*", 0, "md")
   ...
   if not lang then
    return tdbot.sendMessage(msg.to.id, "", 0, "⇋ You can't ➲ globally ban other admins", 0, "md")
else
 ...
 return tdbot.sendMessage(msg.to.id, msg.id, 0, "↜ *کاربر "..matches[2].." از تمام گروه هار ربات محروم شد*", 0, "md")
  ...
  if matches[2] and not string.match(matches[2], '^%d+$') then
    assert(tdbot_function ({
      _ = "searchPublicChat",
      username = matches[2]
    }, action_by_username, {chat_id=msg.to.id,username=matches[2],cmd="superban"}))
      end
   end
 if (matches[1] == "unsuperban" and is_admin(msg) and not Clang) or (matches[1] == "حذف سوپر بن" and is_admin(msg) and Clang) then
if not matches[2] and msg.reply_id then
    assert(tdbot_function ({
      _ = "getMessage",
      chat_id = msg.to.id,
      message_id = msg.reply_id
    }, action_by_reply, {chat_id=msg.to.id,cmd="unsuperban"}))
end
  if matches[2] and string.match(matches[2], '^%d+$') then
...
return tdbot.sendMessage(msg.to.id, msg.id, 0, "↜ *کاربر "..matches[2].." از محرومیت گروه های ربات خارج شد*", 0, "md")
  ...
  if matches[2] and not string.match(matches[2], '^%d+$') then
    assert(tdbot_function ({
      _ = "searchPublicChat",
      username = matches[2]
    }, action_by_username, {chat_id=msg.to.id,username=matches[2],cmd="unsuperban"}))
      end
   end
   if msg.to.type ~= 'pv' then
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
    if userid == our_id then
  if not lang then
  return tdbot.sendMessage(msg.to.id, msg.id, 0, "⇋ I can't ban ➲ *my self*", 0, "md")
   else
  return tdbot.sendMessage(msg.to.id, msg.id, 0, "*↜ من نمیتوانم خودم رو از گروه محروم کنم*", 0, "md")
   ...
   if is_mod1(msg.to.id, userid) then
     if not lang then
    return tdbot.sendMessage(msg.to.id, "", 0, "⇋ You can't ban ➲ *mods,owners or bot admins*", 0, "md")
    else
   ...
   if not lang then
  return tdbot.sendMessage(msg.to.id, "", 0, "⇋ User "..matches[2].." is already ➲ *banned*", 0, "md")
  else
...
kick_user(matches[2], msg.to.id)
   if not lang then
 return tdbot.sendMessage(msg.to.id, msg.id, 0, "⇋ User "..matches[2].." has been ➲ *banned*", 0, "md")
  else
 ...
 if (matches[1] == "unban" and is_mod(msg) and not Clang) or (matches[1] == "ان بن" and is_mod(msg) and Clang) then
if not matches[2] and msg.reply_id then
    assert(tdbot_function ({
      _ = "getMessage",
      chat_id = msg.to.id,
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   if not lang then
   return tdbot.sendMessage(msg.to.id, "", 0, "⇋ User "..matches[2].." is not ➲ *banned*", 0, "md")
  else
...
channel_unblock(msg.to.id, matches[2])
   if not lang then
return tdbot.sendMessage(msg.to.id, msg.id, 0, "⇋ User "..matches[2].." has been ➲ *unbanned*", 0, "md")
   else
return tdbot.sendMessage(msg.to.id, msg.id, 0, "↜ *کاربر "..matches[2].." از محرومیت گروه خارج شد*", 0, "md")
 ...
 if (matches[1] == "silent" and is_mod(msg) and not Clang) or (matches[1] == "سایلنت" and is_mod(msg) and Clang) then
if not matches[2] and msg.reply_id then
    assert(tdbot_function ({
      _ = "getMessage",
      chat_id = msg.to.id,
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
    if userid == our_id then
  if not lang then
  return tdbot.sendMessage(msg.to.id, msg.id, 0, "↜ I can't ➲ silent *my self*", 0, "md")
   else
  return tdbot.sendMessage(msg.to.id, msg.id, 0, "*↜ من نمیتوانم توانایی چت کردن رو از خودم بگیرم*", 0, "md")
   ...
   if is_mod1(msg.to.id, userid) then
   if not lang then
   return tdbot.sendMessage(msg.to.id, "", 0, "⇋ You can't ➲ silent mods,leaders or bot admins", 0, "md")
 else
   ...
   if not lang then
   return tdbot.sendMessage(msg.to.id, "", 0, "⇋ User "..matches[2].." is already ➲ *silent*", 0, "md")
   else
...
data[tostring(chat)]['is_silent_users'][tostring(matches[2])] = ""
    save_data(_config.moderation.data, data)
    if not lang then
 return tdbot.sendMessage(msg.to.id, msg.id, 0, "⇋ User "..matches[2].." added to ➲ *silent users list*", 0, "md")
  else
 ...
 if (matches[1] == "unsilent" and is_mod(msg) and not Clang) or (matches[1] == "ان سایلنت" and is_mod(msg) and Clang) then
if not matches[2] and msg.reply_id then
    assert(tdbot_function ({
      _ = "getMessage",
      chat_id = msg.to.id,
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   if not is_silent_user(matches[2], chat) then
     if not lang then
     return tdbot.sendMessage(msg.to.id, "", 0, "⇋ User "..matches[2].." is not ➲ *silent*", 0, "md")
   else
...
data[tostring(chat)]['is_silent_users'][tostring(matches[2])] = nil
    save_data(_config.moderation.data, data)
   if not lang then
 return tdbot.sendMessage(msg.to.id, msg.id, 0, "⇋ User "..matches[2].." removed from ➲ *silent users list*", 0, "md")
  else
  ...
  if matches[2] and not string.match(matches[2], '^%d+$') then
   assert(tdbot_function ({
     ...
     if not lang then
			...
			if (matches[2] == 'silentlist' and not Clang) or (matches[2] == 'لیست سایلنت' and Clang) then
 ...
 if (matches[1] == "gbanlist" and is_admin(msg) and not Clang) or (matches[1] == "لیست سوپر بن" and is_admin(msg) and Clang) then
  return gbanned_list(msg)
   ...
   if msg.to.type ~= 'pv' then
 if (matches[1] == "silentlist" and is_mod(msg) and not Clang) or (matches[1] == "لیست سایلنت" and is_mod(msg) and Clang) then
